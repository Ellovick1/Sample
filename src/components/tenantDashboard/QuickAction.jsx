  ...
  return (
    <section>
      ...
      <div className="container mx-auto px-5">
        <a href="#" className="text-[#6C63FF] px-5 underline">Quick Actions</a>
      </div>
      ...
      <div class="container px-5 md:pl-20 grid md:flex  flex-wrap sm:grid-cols-2  gap-10 md:mx-auto py-5 bg-[#121122] text-white">
        ...
        <div className="flex gap-8">
          <div>
            ...
            <a className="underline pl-2" href="#">AddTenants</a>
          </div>
          <a href="#" className="underline">Add Flats</a>
        </div>

        <div className="flex gap-4">
          <div>
            <i class="bi bi-bell text-[#D0CA38]"></i>
            <a href="#" className="underline pl-2">Set Remainder</a>
          </div>
          <a href="#" className="underline">Generate Invoice</a>
        </div>
