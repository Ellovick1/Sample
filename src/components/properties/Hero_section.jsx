      ...
      <div className="py-8 md:py-4 ">
          <div className="md:pt-[10rem]">
             <div className="space-y-1 max-w-[24rem]">
               <h3 className="font-bold md:leading-[56px] text-[2.7em] text-[#000]"> Become a Digital Tenant  & Connect with management </h3>
             
             </div>
          </div>
          <div className='max-w-[24rem]'>
              <p className="font-medium text-[0.9rem] md:text-[1rem] text-base leading-[1.75em]" >Pay rent , save for rent smalll and utility bills online, hold your landlord responsible by requesting for maintenace all in our platform.</p>
          </div>
          <div className="pt-[20px]">
             <div className="get-btn-wrapper justify-start flex gap-[20px]">
             <button 
         ...
         <div className = "mt-[5rem] md:h-[641px]"> 
                      <img src={buildings} alt="buildings" className="w-[100%] object-contain h-[100%]"/>
         </div>    

    </div>

    <div className="hero-section-container grid lg:grid-cols-1 lg:pl-0 lg:p-20 md:pl-20 p-4">
          ...
          <div className='bg-[#ffffff61] max-w-[18rem] service-charge lg:relative lg:m-0 m-auto right-[10rem]'>
